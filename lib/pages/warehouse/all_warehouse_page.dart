...
class AllWarehousesPage extends StatefulWidget {
  @override
  _AllWarehousesPageState createState() => _AllWarehousesPageState();
}

class _AllWarehousesPageState extends State<AllWarehousesPage> {
  @override
            ...
            return Padding(
              ...
              child: ListView(
                children: snapshot.data!.docs.map((warehouse) {
                  ...
                  return WarehouseCard(currentWarehouse: currentWarehouse);
                }).toList(),
              ),
            );
          }
...
class WarehouseCard extends StatelessWidget {
  ...
  const WarehouseCard({Key? key, required this.currentWarehouse})
      : super(key: key);
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    DetailWarehousePage(warehouseId: currentWarehouse.id),
              ),
            );
          },
          child: Padding(
              ...
              children: [
                ClipRRect(
                  ...
                  child: currentWarehouse.warehouseImageUrl != null
                      ? CachedNetworkImage(
                          imageUrl: currentWarehouse.warehouseImageUrl!,
                      ...
                      : Container(
                          ...
                          child: Icon(
                            Icons.store, // Placeholder icon when image is null
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: currentWarehouse.warehouseStatus ==
                                        'available'
                                    ? pjsSemiBold14Green
                                    : pjsSemiBold14Red,
                              ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(formatRupiah(currentWarehouse.pricePerMonth),
