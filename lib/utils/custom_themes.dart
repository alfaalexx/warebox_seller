...
const pjsMedium16Grey = TextStyle(
  fontFamily: 'Plus Jakarta Sans',
...
const pjsMedium16Black2 = TextStyle(
  fontFamily: 'Plus Jakarta Sans',
...
const pjsSemiBold16Red = TextStyle(
  fontFamily: 'Plus Jakarta Sans',
  color: Color(0xFFFA4D5E),
  fontSize: 16,
  fontWeight: FontWeight.w600,
